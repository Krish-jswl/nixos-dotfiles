//--- ZepharDev Nvim
{
  ...
  "temperature": {
    ...
    "format-icons": ["0", "", ""],
    "on-click": "kitty -e zsh -c 'btop; exec zsh'",
  },
...
"idle_inhibitor": {
  ...
  "custom/pacman": {
    ...
    "on-click": "kitty -e zsh -c 'sudo pacman -Syu; exec zsh'", // update system
    "signal": 8,
  },
  "custom/notification": {
    "tooltip": false,
  ...
  // Custom module configuration for waybar personalization modules.
   ...
   "custom/github": {   
    ...
    "custom/instagram": {
    "format": "",
    "on-click": "xdg-open https://wwww.instagram.com",
    "tooltip": false,
  },
    "custom/ip": {
    "format": {},
  ...
  // Experimental module for music player of playerctl
  // this module; Next, Pause, Previous 
  "custom/next": {
    "format": "󰙡 ",
  ...
  "custom/pause": {
    "format": "{icon}",
//    "exec": "playerctl -l 2>/dev/null | head -n 1",
  ...
  "custom/music": {
    "exec": "playerctl -p $(playerctl -l | head -n 1) status",
    "on-click": "playerctl -p $(playerctl -l | head -n 1) play-pause",
    "on-scroll-up": "playerctl -p $(playerctl -l | head -n 1) next",
    "on-scroll-down": "playerctl -p $(playerctl -l | head -n 1) previous",
    "format": "{icon} {status}",
  ...
  "custom/catppuccin-theme": {
    "format": "󰏘",
    "on-click": "~/.config/waybar/scripts/catppuccin.sh",
    "tooltip": false,
  },
  "custom/keybinds": {
    "format": "",
    "on-click": "~/.config/rofi/shortcut/script.sh",
